...
class Population
{
    ...
    public:
        ...
        void BigMutate(int seuil_a_atteindre);//essaie de faire muter tous les individus d'une famille jusqu'au seuil_a_atteindre

        void evolutionnaryProcess();//récupère le plus nul de chaque famille et tente de le faire muter qu'une fois
