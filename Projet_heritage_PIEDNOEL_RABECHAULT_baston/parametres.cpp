...
int Parameters::individualsNb =NbIndividus; //11
int Parameters::marge_match_nul=5;//5
int Parameters::generationsMaxNb = 100;//100
int Parameters::skillMoyen = 60;//60
...
// - rien : aléatoire
// ******************************************************
MyRandom *Parameters::randomGenerator=new MyRandom(10);

//######!ATTENTION!####### ces valeurs ne fonctionnent qu'avec les valeurs de paramètre en commentaire
...
void Parameters::details()
{
    ...
    cout<<"(la mutation s'effectue en copiant un individu, on tente de muter 1 fois, et on supprime l'ancien individu)"<<endl;
